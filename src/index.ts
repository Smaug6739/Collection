...
export class Collection<K, V> extends Map<K, V> {
  ...
  public updateIf(data: IMap, filter: Function): this | null {
    if (!data.key || !data.value)
      throw new TypeError(
        "[MISSING_PARAMETER] The data parameter must be specified with key and value property."
      );
    if (!filter)
      throw new TypeError(
        "[MISSING_PARAMETER] The filter parameter must be specified."
      );
  ...
  public deleteIf(key: K, filter: Function): this | null {
    if (!key)
      throw new TypeError(
        "[MISSING_PARAMETER] The key parameter must be specified with key and value property."
      );
    if (!filter)
      throw new TypeError(
        "[MISSING_PARAMETER] The filter parameter must be specified."
  ...
  public concat(
    ...maps: Array<Collection<K, V> | Map<K, V>>
  ): Collection<K, V> {
